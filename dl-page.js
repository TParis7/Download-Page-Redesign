/* ============================================================
   ...
   • Hero mockup: iphone-mockup-v2.png (the old app) -> the
     ...
     (Home in front, Milestones behind, the 9:41 App Store
     captures), served from this repo as a webp. Source HTML in
     Website Folder/Download Page/iphone-mockup-redesign.html.
   v3.1.3 (2026-07-07):
...
(function () {
  ...
  function loadFonts() {
    ...
    f3.rel = 'stylesheet';
    f3.href = 'https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400..800&family=Plus+Jakarta+Sans:wght@400..800&display=swap';
...
'.dl-page{font-family:"Plus Jakarta Sans",sans-serif;color:#1a1a1a;overflow-x:hidden;-webkit-font-smoothing:antialiased}',
...
'.dl-section-header h2{font-family:"Bricolage Grotesque",sans-serif;font-size:clamp(28px,3.4vw,42px);font-weight:600;line-height:1.15;max-width:720px;margin:0 auto;color:var(--dark);letter-spacing:-0.01em;}',
...
'.dl-safety-card h3{font-family:"Bricolage Grotesque",sans-serif;font-size:18px;font-weight:600;color:#fff;line-height:1.25;margin-bottom:8px;letter-spacing:-0.005em;}',
...
'.dl-quote-mark{font-family:"Bricolage Grotesque",sans-serif;font-size:180px;line-height:.6;color:var(--crimson);opacity:.35;position:absolute;top:-40px;left:-20px;pointer-events:none;z-index:0;user-select:none}',
'.dl-talent-statement h2{font-family:"Bricolage Grotesque",sans-serif;font-size:clamp(40px,5.8vw,80px);font-weight:600;line-height:1.02;color:var(--dark);letter-spacing:-0.03em;position:relative}',
...
'.dl-talent-stat .num{font-family:"Bricolage Grotesque",sans-serif;font-size:42px;font-weight:700;line-height:1;color:var(--dark);letter-spacing:-0.02em}',
...
'.dl-final-cta h2{font-family:"Bricolage Grotesque",sans-serif;font-size:46px;font-weight:600;color:#fff;margin-bottom:18px;letter-spacing:-0.01em;}',
...
'.dl-footer-grid{display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px;max-width:1100px;margin:0 auto 40px;padding-bottom:40px;border-bottom:1px solid rgba(255,255,255,.1)}',
'.dl-footer-brand{display:flex;flex-direction:column}',
'.dl-footer-brand .p3-footer-logo{height:36px;width:auto;filter:brightness(0) invert(1);margin-bottom:12px}',
'.dl-footer-brand .dl-footer-tagline{font-size:13px;color:rgba(255,255,255,.5);line-height:1.6;margin-top:0;margin-bottom:16px}',
'.dl-footer-brand .dl-footer-location{margin-top:10px;margin-bottom:16px;font-size:12px;color:rgba(255,255,255,.4)}',
'.dl-footer-col{display:flex;flex-direction:column;gap:4px}',
'.dl-footer-col h4{font-family:"Plus Jakarta Sans",sans-serif;font-size:11px;font-weight:700;color:rgba(255,255,255,.8);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:14px}',
...
'.dl-footer-bottom{max-width:1200px;margin:0 auto;padding-top:0;font-size:12px;color:rgba(255,255,255,.4);display:flex;justify-content:space-between;align-items:center}',
...
'}',
'/* 991px: Nav switches to mobile (matches hp-shared-sections.js breakpoint) */',
...
'  .dl-footer-grid{grid-template-columns:1fr 1fr;gap:24px 16px}',
'  .dl-footer-brand{grid-column:1 / -1}',
'  .dl-footer-bottom{flex-wrap:wrap;justify-content:center;text-align:center}',
...
'}',
  ...
  ---------------------------------------------------------- */
  function buildNav() {
    // Nav v2 (Sep 2026): the shared public-site nav, same markup, styles and behaviour as the other
    // eight public pages (Website Folder/site-chrome/apply-nav.py). Returns the shape init() expects.
    var nav = el('div', { className: 'p3-nav', id: 'p3nav' });
    nav.innerHTML = '<a href="https://www.pulseofp3.org/" class="p3-nav-logo" aria-label="Pulse of Perseverance Project"><img src="https://cdn.prod.website-files.com/69b02f65f0068e9fb16f09f7/69b02f65f0068e9fb16f0df1_P3%20Logo.svg" alt="P3 - Pulse of Perseverance" class="p3-nav-logo-img"></a> <div class="p3-nav-links"> <a href="https://www.pulseofp3.org/for-students" class="p3-nav-link">For Students</a> <a href="https://www.pulseofp3.org/for-mentors" class="p3-nav-link">For Mentors</a> <a href="https://www.pulseofp3.org/platform" class="p3-nav-link">Platform</a> <a href="https://www.pulseofp3.org/about/about" class="p3-nav-link">About</a> </div> <div class="p3-nav-actions"> <a href="https://enterprise.pulseofp3.org/overview" class="p3-nav-btn p3-nav-btn-enterprise">Enterprise</a> <a href="https://platform.pulseofp3.org/" class="p3-nav-btn p3-nav-btn-login">Login</a> </div> <button type="button" class="pp-mob-menu" id="hamburger" aria-label="Menu" aria-expanded="false"><span></span><span></span><span></span></button>';
    var mobileMenu = el('div', { className: 'pp-mob-overlay', id: 'pp-mob-overlay' });
    mobileMenu.innerHTML = '<a class="p3-menu-scrim" href="javascript:void(0)" aria-hidden="true" tabindex="-1"></a> <div class="p3-menu" role="dialog" aria-modal="true" aria-label="Menu"> <div class="p3-menu-top"> <img src="https://cdn.prod.website-files.com/69b02f65f0068e9fb16f09f7/69b02f65f0068e9fb16f0df1_P3%20Logo.svg" alt="P3" class="p3-menu-logo"> <a class="p3-menu-close" href="javascript:void(0)" role="button">Close</a> </div> <nav class="p3-menu-nav" aria-label="Site"> <a href="https://www.pulseofp3.org/for-students">For Students</a> <a href="https://www.pulseofp3.org/for-mentors">For Mentors</a> <a href="https://www.pulseofp3.org/platform">Platform</a> <a href="https://www.pulseofp3.org/about/about">About</a> </nav> <div class="p3-menu-actions"> <a href="https://enterprise.pulseofp3.org/overview" class="p3-nav-btn p3-nav-btn-enterprise">Enterprise</a> <a href="https://platform.pulseofp3.org/" class="p3-nav-btn p3-nav-btn-login">Login</a> </div> <a class="p3-menu-download" href="https://www.pulseofp3.org/download"> <span class="p3-menu-download-eyebrow">Free on iOS and Android</span> <span class="p3-menu-download-title">Get the P3 app</span> <span class="p3-menu-download-cta">Download the app</span> </a> </div>';
    var burger = nav.querySelector('.pp-mob-menu');
    ...
    burger.addEventListener('click', function () { setOpen(!mobileMenu.classList.contains('open')); });
    mobileMenu.querySelectorAll('a').forEach(function (a) { a.addEventListener('click', function () { setOpen(false); }); });
